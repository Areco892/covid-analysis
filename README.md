...
## Acknowledgement
I stumbled upon a youtube video title "Data Analyst Portfolio Project | SQL Data Exploration | Project 1/4" from Alex The Analyst, very cool stuff! So, I created this repository to practice my data exploration skills using PostgreSQL and also to keep track of my progress in becoming a Data Analyst.
