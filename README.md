...
- In setup.py, used python and pandas to convert those excel files into csv files.
- In pgAdmin created a two tables, one for deaths and one for vaccinations using the commands in *table_creation.sql*.
